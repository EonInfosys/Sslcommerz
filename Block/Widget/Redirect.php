...
namespace Sslcommerz\Payment\Block\Widget;
...
class Redirect extends Template
{
    ...
    public function __construct(
        ...
        \Sslcommerz\Payment\Model\Sslcommerznew $paymentConfig,
        array $data = []
    ) {
    ...
    public function getPostData()
    {
        ...
        if ($orderId) {
            ...
            //return  $resultRedirect->setPath('customer/index/new', ['order_id' => $incrementId]);
            //return  resultRedirect->setPath('sslcommerzipn/order/payment?order_id=3376');
            return $this->Config->getPostData($incrementId);
        }
    }
